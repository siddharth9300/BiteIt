...
const NavList = ({ toggleNav, setToggleNav, auth }) => {
  ...
  return (
    ...
    //   } fixed top-22 right-5 lg:right-8 p-3 w-fit bg-white bg-opacity-10 backdrop-blur-sm flex flex-col justify-center items-start rounded-lg shadow-md border border-white font-bold text-gray-600 transtion-all duration-500 ease-in-out`}
    // >
    <>
      {auth ? (
